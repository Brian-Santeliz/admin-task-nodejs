  ...
  btn.addEventListener("click", function (e) {
    ...
    sweetalert2__WEBPACK_IMPORTED_MODULE_0___default().fire({
      ...
      if (result.isConfirmed) {
        ...
        axios__WEBPACK_IMPORTED_MODULE_1___default().delete(peticion).then(console.log)["catch"](console.log);
        sweetalert2__WEBPACK_IMPORTED_MODULE_0___default().fire("Eliminado!", "Este proyecto ha sido eliminado.", "success");
        setTimeout(function () {
